...
public class LISPParser
{
  ...
  public enum SymbolKind
  {
    ...
    S_LeftBracket(5),              /* LeftBracket  */
    S_RightBracket(6),             /* RightBracket  */
    S_YYACCEPT(7),                 /* $accept  */
    S_Program(8),                  /* Program  */
    S_List(9),                     /* List  */
    S_Elements(10),                /* Elements  */
    S_Element(11),                 /* Element  */
    S_Atom(12);                    /* Atom  */
    ...
    private static final SymbolKind[] values_ = {
      ...
      SymbolKind.S_LeftBracket,
      SymbolKind.S_RightBracket,
  ...
  private static final String[] yytname_init()
  {
    return new String[]
    {
  "\"end of file\"", "error", "\"invalid token\"", "Literal",
  "Identifier", "LeftBracket", "RightBracket", "$accept", "Program",
  "List", "Elements", "Element", "Atom", null
    };
  }
  ...
  public interface Lexer {
    ...
    /** Token LeftBracket, to be returned by the scanner.  */
    static final int LeftBracket = 260;
    /** Token RightBracket, to be returned by the scanner.  */
  ...
  private final class YYStack {
    ...
    private TreeNode[] valueStack = new TreeNode[16];

    public int size = 16;
    public int height = -1;

    public final void push(int state, TreeNode value) {
      height++;
      if (size == height) {
        ...
        TreeNode[] newValueStack = new TreeNode[size * 2];
    ...
    public final TreeNode valueAt(int i) {
  ...
  private int yyaction(int yyn, YYStack yystack, int yylen)
  {
    ...
    TreeNode yyval = (0 < yylen) ? yystack.valueAt(yylen - 1) : yystack.valueAt(0);
...
/* "syntax.java":462  */
  ...
  public static final class Context {
    Context(LISPParser parser, YYStack stack, SymbolKind token) {
      yyparser = parser;
      yystack = stack;
      yytoken = token;
    }

    private LISPParser yyparser;
    ...
    static final int NTOKENS = LISPParser.YYNTOKENS_;
