       ...
       users should not rely upon it.  */
        ...
        switch (yyn) {
            case 2: /* Program: Elements  */
                if (yyn == 2)
                    /* "syntax.y":35  */ {
                    node = new TreeNode("Program").addChild(yystack.valueAt(0));
                    yyval = node;
                }
                ;
                break;
            ...
            case 5: /* Elements: Elements Element  */
                if (yyn == 5)
                    /* "syntax.y":39  */ {
                    TreeNode<String> elem = (TreeNode<String>) yystack.valueAt(1);
                    yyval = elem.addChild(yystack.valueAt(0));
                }
                ;
                break;
